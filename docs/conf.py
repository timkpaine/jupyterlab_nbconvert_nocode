...
latex_documents = [
    (
        master_doc,
        "jupyterlab_nbconvert_nocode.tex",
        "jupyterlab_nbconvert_nocode Documentation",
        "Tim Paine",
        "manual",
    ),
]
...
def run_apidoc(_):
    ...
    jupyterlab_nbconvert_nocode_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "jupyterlab_nbconvert_nocode")
    )
